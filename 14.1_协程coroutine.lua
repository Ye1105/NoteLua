...
LastEditTime: 2023-03-16 09:41:06
FilePath: \LuaLesson\14.1_协程coroutine.lua
...
print(coroutine.status(handle)) -- 挂起状态，等待执行或结束 （你拿到小号，等待着叫号，下一步，也可能这个号作废，也可能叫你去办业务）
